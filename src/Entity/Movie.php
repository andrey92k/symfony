...
class Movie
{
    ...
    private ?\DateTimeInterface $data_release = null;
    ...
    public function getDataRelease(): ?\DateTimeInterface
    {
        return $this->data_release;
    }

    public function setDataRelease(?\DateTimeInterface $data_release): self
    {
